...
2.  **Verificación de acceso a la red:** Para comprobar la conectividad al servidor o al puerto (IP del computador) donde se encuentra la base de datos PostgreSQL.
