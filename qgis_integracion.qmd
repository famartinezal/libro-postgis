...
4.  **Activación de la contraseña maestra y creación de credenciales cifradas**
    ...
    -   Nombre: Asigne un nombre referente a la base de datos que tendrá acceso.
...
5.  Creación de la conexión a PostgreSQL
    ...
    ![](assets/Administrador fuente de datos.png)

    Dirección del servidor al que se conectará el sistema (IP o dirección del dominio).
