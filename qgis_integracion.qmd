...
3.  En la ventana *Importar capa vectorial* se encuentran las siguientes opciones:
    ...
    -   Esquema: Seleccione en la base de datos el esquema **stg** para guardar el archivo a importar, será almacenado como stg.Puntos.
        ...
        ![](assets/Tipo_de_salida_esquema.png)

    -   Tabla: Corresponde al nombre de la capa que importará dentro del esquema. Puede seleccionar la capa en el menú desplegable con el fin de que quede con el mismo nombre de la que tiene en el lienzo de trabajo, o puede escribir el nombre que desee teniendo en presentes los aspectos mencionados previamente para la nomenclatura de archivos.
    ...
    -   Comentario: Se puede añadir una nota o descripción sobre la capa, el texto se guardará como metadato en la base de datos, es decir que proporcionan información sobre los datos.
