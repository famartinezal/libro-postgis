...
3.  En la ventana *Importar capa vectorial* se encuentran las siguientes opciones:
    ...
    -   Codificación: Puede definir la codificación del texto, es decir como se guardan los caracteres. Seleccione UFT-8 para asegurar que compatibilidad con tildes y caracteres especiales como la "ñ".

    -   Sustituir las capas de destino (si existe):
