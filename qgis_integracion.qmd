...
1. Abra QGIS y use *Administrador de fuentes de datos*.
2. Seleccione **PostgreSQL** y cree una conexión nueva.
3. Complete parámetros de host, puerto, base `sig_fedearroz_fna` y active SSL si aplica.
4. Guarde credenciales en `pg_service.conf` o `.pgpass` para evitar contraseñas en texto plano.
