...
## Cargar capas o tablas a la base de datos
...
3.  En la ventana *Importar capa vectorial* se encuentran las siguientes opciones:
    ...
    -   Entrada: En el menú desplegado seleccione la capa que desea importar, aparecerán solo las capas que se encuentran cargadas en QGIS. El archivo también puede exportarlo desde su ordenador dando click en los tres puntos y seleccionando el archivo donde lo tenga guardado. En este apartado también se encuentra la opción *Importar sólo objetos espaciales seleccionados*, se importarán solo las entidades espaciales que tenga seleccionadas.

    -   Esquema: Seleccione el esquema (carpeta o contendeor) de la base de datos donde guardará el archivo, en este caso es stg y se almacenará como stg.Puntos.

    -   Tabla: Escriba el nombre de la capa que importará dentro del esquema. Reemplazar los espacios, si los hay, por guión al piso ( \_ ). En el menú desplegado encontrará las capas contenidas en el esquema seleccionado. En el ejemplo, el archivo se llamará Puntos.
    ...
    -   SRID de destino: SRC que tendrá la capa una vez importada. Se puede conservar el de origen si es EPSG:32618 - WGS / UTM zone 18N, o reproyectarlo a este. Es indispensable que las capas importadas estén proyectadas en el SRC anteriormente mencionado, con el fin de que los resultados de los análisis sean correctos y estandarizar procesos en los que las mediciones estén en metros.

    -   Codificación: Puede definir la codificación del texto, es decir como se guardan los caracteres. Seleccione UFT-8 para asegurar el reconocimiento de tildes y caracteres especiales como la "ñ".
    ...
    -   Comentario: Se puede añadir una nota o descripción sobre la capa, el texto se guardará como metadato en la base de datos, es decir que proporcionan información

    ![](assets/Importar_capa_vectorial.png)

4.  

5.  Dato compartido para poder hacer las uniones y diferentes anaálisis.
